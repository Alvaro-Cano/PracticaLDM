...
public class MyBuilds extends AppCompatActivity {
    ...
    public void Buscar(){
        ...
        if(!valor.isEmpty()){
            ...
            if(fila.moveToFirst()){
                ...
                et_campeon.setText(fila.getString(1));
                et_descripcion.setText(fila.getString(2));
                et_objeto1.setText(fila.getString(3));
                et_objeto2.setText(fila.getString(4));
                et_objeto3.setText(fila.getString(5));
                et_objeto4.setText(fila.getString(6));
                et_objeto5.setText(fila.getString(7));
                et_objeto6.setText(fila.getString(8));
            }
        }
        BdD.close();
    }
    ...
    public void Modificar(View view) {
        ...
        if (!nombre.isEmpty() && !campeon.isEmpty() && !descripcion.isEmpty() && !objeto1.isEmpty() && !objeto2.isEmpty() && !objeto3.isEmpty() && !objeto4.isEmpty() && !objeto5.isEmpty() && !objeto6.isEmpty()){
            ...
            BdD.update("builds", registro,"nombre ='" + nombre+"'",null);
    ...
    public void Eliminar(View view) {
        ...
        String valor = getIntent().getStringExtra("Name");
        if(!valor.isEmpty()){
            int cantidad = BdD.delete("builds","nombre ='" + valor+"'",null);
            Intent salir = new Intent(this, Builds.class);
            startActivity(salir);
        }
        BdD.close();
